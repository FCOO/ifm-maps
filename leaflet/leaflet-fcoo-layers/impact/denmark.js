(function () {
     ...
     */
    L.FImpactLayer.replenishment_ecmwf_dk = function(options) {
    ...
    L.FImpactLayer.boarding_ecmwf_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_ECMWF_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://ecmwf.org.dk" alt="European Centre for Medium-Range Weather Forecasts">ECMWF</a>',
        });
    ...
    L.FImpactLayer.helo_tol_ecmwf_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_ECMWF_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://ecmwf.org.dk" alt="European Centre for Medium-Range Weather Forecasts">ECMWF</a>',
        });
    ...
    L.FImpactLayer.rhib_ecmwf_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_ECMWF_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://ecmwf.org.dk" alt="European Centre for Medium-Range Weather Forecasts">ECMWF</a>',
        });
    ...
    L.FImpactLayer.lcp_ecmwf_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_ECMWF_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://ecmwf.org.dk" alt="European Centre for Medium-Range Weather Forecasts">ECMWF</a>',
        });
    ...
    L.FImpactLayer.uav_ecmwf_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_ECMWF_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://ecmwf.org.dk" alt="European Centre for Medium-Range Weather Forecasts">ECMWF</a>',
        });
    ...
    L.FImpactLayer.skiff_ecmwf_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_ECMWF_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://ecmwf.org.dk" alt="European Centre for Medium-Range Weather Forecasts">ECMWF</a>',
        });
    ...
    L.FImpactLayer.dhow_ecmwf_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_ECMWF_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://ecmwf.org.dk" alt="European Centre for Medium-Range Weather Forecasts">ECMWF</a>',
        });
    ...
    L.FImpactLayer.fishingboat_120_ecmwf_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_ECMWF_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://ecmwf.org.dk" alt="European Centre for Medium-Range Weather Forecasts">ECMWF</a>',
        });
    ...
    L.FImpactLayer.fishingboat_500_ecmwf_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_ECMWF_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://ecmwf.org.dk" alt="European Centre for Medium-Range Weather Forecasts">ECMWF</a>',
        });
    ...
    L.FImpactLayer.fishingboat_1000_ecmwf_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_ECMWF_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://ecmwf.org.dk" alt="European Centre for Medium-Range Weather Forecasts">ECMWF</a>',
        });
    ...
    L.FImpactLayer.generic_ecmwf_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_ECMWF_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://ecmwf.org.dk" alt="European Centre for Medium-Range Weather Forecasts">ECMWF</a>',
        });
    ...
    L.FImpactLayer.rhib_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_DMI_FCOO_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://dmi.dk" alt="Danish Meteorological Institute">DMI</a> and <a href="http://fcoo.dk" alt="Danish Defence Center for Operational Oceanography">FCOO</a>'
        });
    ...
    L.FImpactLayer.lcp_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_DMI_FCOO_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://dmi.dk" alt="Danish Meteorological Institute">DMI</a> and <a href="http://fcoo.dk" alt="Danish Defence Center for Operational Oceanography">FCOO</a>'
        });
    ...
    L.FImpactLayer.uav_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_DMI_FCOO_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://dmi.dk" alt="Danish Meteorological Institute">DMI</a> and <a href="http://fcoo.dk" alt="Danish Defence Center for Operational Oceanography">FCOO</a>'
        });
    ...
    L.FImpactLayer.skiff_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_DMI_FCOO_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://dmi.dk" alt="Danish Meteorological Institute">DMI</a> and <a href="http://fcoo.dk" alt="Danish Defence Center for Operational Oceanography">FCOO</a>'
        });
    ...
    L.FImpactLayer.dhow_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_DMI_FCOO_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://dmi.dk" alt="Danish Meteorological Institute">DMI</a> and <a href="http://fcoo.dk" alt="Danish Defence Center for Operational Oceanography">FCOO</a>'
        });
    ...
    L.FImpactLayer.fishingboat_120_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_DMI_FCOO_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://dmi.dk" alt="Danish Meteorological Institute">DMI</a> and <a href="http://fcoo.dk" alt="Danish Defence Center for Operational Oceanography">FCOO</a>'
        });
    ...
    L.FImpactLayer.fishingboat_500_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_DMI_FCOO_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://dmi.dk" alt="Danish Meteorological Institute">DMI</a> and <a href="http://fcoo.dk" alt="Danish Defence Center for Operational Oceanography">FCOO</a>'
        });
    ...
    L.FImpactLayer.fishingboat_1000_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_DMI_FCOO_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://dmi.dk" alt="Danish Meteorological Institute">DMI</a> and <a href="http://fcoo.dk" alt="Danish Defence Center for Operational Oceanography">FCOO</a>'
        });
    ...
    L.FImpactLayer.generic_dk = function (options) {
        var dataset = 'FCOO/IMPACT/IMPACT_DMI_FCOO_DENMARK_v005C.nc';
        options = L.extend(options, {
            attribution: 'Based on forecasts from <a href="http://dmi.dk" alt="Danish Meteorological Institute">DMI</a> and <a href="http://fcoo.dk" alt="Danish Defence Center for Operational Oceanography">FCOO</a>'
        });
