...
(function () {
	L.FLayer.Dmi.visibility = function (options) {
                ...
                return new L.FLayer.Dmi._visibility('DMI/HIRLAM/MAPS_DMI_S03_v005C.nc', options);
	};
	...
	L.FLayer.Dmi.windSpeed = function (options) {
                ...
                var layer1 = new L.FLayer.Dmi._windSpeed('DMI/HIRLAM/MAPS_DMI_S03_v005C.nc', options);
	...
	L.FLayer.Dmi.windDirection = function (options) {
                options = L.extend(options, {attribution: 'Wind forecasts from <a href="http://dmi.dk" alt="Danish Meteorological Institute">DMI</a>'});
                var layer1 = new L.FLayer.Dmi._windDirection('DMI/HIRLAM/MAPS_DMI_S03_v005C.nc', options);
                return new L.FLayerGroup([layer1]);
	};
	...
	L.FLayer.Dmi.humidity = function (options) {
                ...
                var layer1 = new L.FLayer.Dmi._humidity('DMI/HIRLAM/MAPS_DMI_S03_v005C.nc', options);
                return new L.FLayerGroup([layer1]);
	};
	L.FLayer.Dmi._humidity = function (dataset, options) {
		...
		if (layer.options.legendImagePath == null) {
                        layer.options.legendAttribution = 'Source: <a href="http://dmi.dk" alt="Danish Meteorological Institute">DMI</a> / HIRLAM / SKA';
			layer.options.legendImagePath = layer._fcootileurl + '?SERVICE=WMS&REQUEST=GetColorbar&VERSION=1.1.1&LAYERS=SPFH&STYLES=horizontal&FORMAT=image%2Fpng&TRANSPARENT=false&CMAP=Humidity_kg_kg_WYR_7colors';
		}
		return layer;
	};
	...
	L.FLayer.Dmi.airTemperature = function (options) {
                ...
                var layer1 = new L.FLayer.Dmi._airTemperature('DMI/HIRLAM/MAPS_DMI_S03_v005C.nc', options);
                return new L.FLayerGroup([layer1]);
	};
	L.FLayer.Dmi._airTemperature = function (dataset, options) {
                var extraoptions = {layers: 'TMP', cmap: 'AirTemp_C_BGYR_19colors'};
                options = L.extend(options, extraoptions);
		var layer = new L.FLayer(dataset, options);
		if (layer.options.legendImagePath == null) {
                        layer.options.legendAttribution = 'Source: <a href="http://dmi.dk" alt="Danish Meteorological Institute">DMI</a> / HIRLAM / SKA';
			layer.options.legendImagePath = layer._fcootileurl + '?SERVICE=WMS&REQUEST=GetColorbar&VERSION=1.1.1&LAYERS=TMP&STYLES=horizontal&FORMAT=image%2Fpng&TRANSPARENT=false&CMAP=AirTemp_C_BGYR_19colors';
		}
		return layer;
	};
	...
	L.FLayer.Dmi.seaLevelPressure = function (options) {
                ...
                var layer1 = new L.FLayer.Dmi._seaLevelPressure('DMI/HIRLAM/MAPS_DMI_S03_v005C.nc', options);
                return new L.FLayerGroup([layer1]);
	};
	...
	L.FLayer.Dmi.totalCloudCover = function (options) {
                ...
                var layer1 = new L.FLayer.Dmi._totalCloudCover('DMI/HIRLAM/MAPS_DMI_S03_v005C.nc', options);
                return new L.FLayerGroup([layer1]);
	};
	L.FLayer.Dmi._totalCloudCover = function (dataset, options) {
		...
		if (layer.options.legendImagePath == null) {
                        layer.options.legendAttribution = 'Source: <a href="http://dmi.dk" alt="Danish Meteorological Institute">DMI</a> / HIRLAM / SKA';
			layer.options.legendImagePath = layer._fcootileurl + '?SERVICE=WMS&REQUEST=GetColorbar&VERSION=1.1.1&LAYERS=TCDC&STYLES=horizontal&FORMAT=image%2Fpng&TRANSPARENT=false&CMAP=CloudCover_km_WGB_10colors';
		}
		return layer;
	};
        ...
        L.FLayer.Dmi.totalPrecipitation = function (options) {
                ...
                return new L.FLayer.Dmi._totalPrecipitation('DMI/HIRLAM/MAPS_DMI_S03_v005C.nc', options);
        };
