...
(function () {
	L.FLayer.windSpeed = function (options) {
                ...
                var layer1 = new L.FLayer._windSpeed('DMI/HIRLAM/GETM_DMI_HIRLAM_T15_v004C.nc', options);
	...
	L.FLayer.windDirection = function (options) {
                options = L.extend(options, {attribution: 'Wind forecasts from <a href="http://dmi.dk" alt="Danish Meteorological Institute">DMI</a>'});
                var layer1 = new L.FLayer._windDirection('DMI/HIRLAM/GETM_DMI_HIRLAM_T15_v004C.nc', options);
                return new L.FLayerGroup([layer1]);
	};
	...
	L.FLayer.humidity = function (options) {
                ...
                var layer1 = new L.FLayer._humidity('DMI/HIRLAM/GETM_DMI_HIRLAM_T15_v004C.nc', options);
                return new L.FLayerGroup([layer1]);
	};
	...
	L.FLayer.airTemperature = function (options) {
                ...
                var layer1 = new L.FLayer._airTemperature('DMI/HIRLAM/GETM_DMI_HIRLAM_T15_v004C.nc', options);
                return new L.FLayerGroup([layer1]);
	};
	...
	L.FLayer.seaLevelPressure = function (options) {
                ...
                var layer1 = new L.FLayer._seaLevelPressure('DMI/HIRLAM/GETM_DMI_HIRLAM_T15_v004C.nc', options);
                return new L.FLayerGroup([layer1]);
	};
	...
	L.FLayer.totalCloudCover = function (options) {
                ...
                var layer1 = new L.FLayer._totalCloudCover('DMI/HIRLAM/GETM_DMI_HIRLAM_T15_v004C.nc', options);
                return new L.FLayerGroup([layer1]);
	};
