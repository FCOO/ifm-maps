...
(function () {
	L.FLayer.Ecmwf.windSpeed = function (options) {
                ...
                return new L.FLayer.Ecmwf._windSpeed('ECMWF/DXD/MAPS_ECMWF_DXD_DENMARK.nc', options);
	};
	...
	L.FLayer.Ecmwf.windDirection = function (options) {
                options = L.extend(options, {attribution: 'Wind forecasts from <a href="http://www.ecmwf.int" alt="European Centre for Medium-Range Weather Forecasts">ECMWF</a>'});
                return new L.FLayer.Ecmwf._windDirection('ECMWF/DXD/MAPS_ECMWF_DXD_DENMARK.nc', options);
	};
	...
	L.FLayer.Ecmwf.airTemperature = function (options) {
                ...
                return new L.FLayer.Ecmwf._airTemperature('ECMWF/DXD/MAPS_ECMWF_DXD_DENMARK.nc', options);
	};
	...
	L.FLayer.Ecmwf.seaLevelPressure = function (options) {
                ...
                return new L.FLayer.Ecmwf._seaLevelPressure('ECMWF/DXD/MAPS_ECMWF_DXD_DENMARK.nc', options);
	};
	...
	L.FLayer.Ecmwf.totalCloudCover = function (options) {
                ...
                return new L.FLayer.Ecmwf._totalCloudCover('ECMWF/DXD/MAPS_ECMWF_DXD_DENMARK.nc', options);
	};
	...
	L.FLayer.Ecmwf.totalPrecipitation = function (options) {
                ...
                return new L.FLayer.Ecmwf._totalPrecipitation('ECMWF/DXD/MAPS_ECMWF_DXD_DENMARK.nc', options);
	};
	...
	L.FLayer.Ecmwf.seaIceCover = function (options) {
                ...
                return new L.FLayer.Ecmwf._seaIceCover('ECMWF/DXD/MAPS_ECMWF_DXD_DENMARK.nc', options);
	};
