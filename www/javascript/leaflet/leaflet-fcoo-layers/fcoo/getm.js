...
(function () {
	L.FLayer.currentSpeed = function (options) {
                ...
                var layer1 = new L.FLayer._currentSpeed('FCOO/GETM/metoc.full_dom.velocities.surface.3nm.1h.NS1C-v001C.nc', options);
	...
	L.FLayer.currentDirection = function (options) {
                options = L.extend(options, {attribution: 'Current forecasts from <a href="http://fcoo.dk" alt="Danish Defence Center for Operational Oceanography">FCOO</a>'});
                var layer1 = new L.FLayer._currentDirection('FCOO/GETM/metoc.full_dom.velocities.surface.3nm.1h.NS1C-v001C.nc', options);
	...
	L.FLayer.elevation = function (options) {
                ...
                var layer1 = new L.FLayer._elevation('FCOO/GETM/metoc.dk.2Dvars.1nm.2D.1h.NS1C-v001C.nc', options);
                return new L.FLayerGroup([layer1]);
	};
	L.FLayer._elevation = function (dataset, options) {
