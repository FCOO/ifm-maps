...
(function () {
	L.FLayer.currentSpeed = function (options) {
                ...
                var layer1 = new L.FLayer._currentSpeed('NOAA/HYCOM/NOAA_HYCOM_GREENLAND.nc', options);
	...
	L.FLayer.currentDirection = function (options) {
                options = L.extend(options, {attribution: 'Current forecasts from <a href="http://noaa.gov" alt="National Oceanic and Atmospheric Administration">NOAA</a>'});
                var layer1 = new L.FLayer._currentDirection('NOAA/HYCOM/NOAA_HYCOM_GREENLAND.nc', options);
	...
	L.FLayer.sss = function (options) {
                ...
                var layer1 = new L.FLayer._sss('NOAA/HYCOM/NOAA_HYCOM_GREENLAND.nc', options);
                return new L.FLayerGroup([layer1]);
	};
	...
	L.FLayer.sst = function (options) {
                ...
                var layer1 = new L.FLayer._sst('NOAA/HYCOM/NOAA_HYCOM_GREENLAND.nc', options);
                return new L.FLayerGroup([layer1]);
	};
