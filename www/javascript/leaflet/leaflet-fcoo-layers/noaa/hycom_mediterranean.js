...
(function () {
	...
	L.FLayer.Noaa._currentSpeed = function (dataset, options) {
		...
		if (layer.options.legendImagePath == null) {
			...
			layer.options.legendImagePath = layer._fcootileurl + '?SERVICE=WMS&REQUEST=GetColorbar&VERSION=1.1.1&LAYERS=u_velocity_v_velocity&STYLES=horizontal&FORMAT=image%2Fpng&TRANSPARENT=false&CMAP=Current_kn_GYR_11colors';
		}
		return layer;
	};
