(function (){
    ...
    /*exported initCommonMapImpact*/

    /**
     * Initialize the map.
     */
    function initCommonMapImpact(langs, basemap, maps, minZoom, maxZoom, zoom, lat,
    ...
    window.initCommonMapImpact = initCommonMapImpact;
