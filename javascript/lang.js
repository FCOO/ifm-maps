    ...
    function getI18n(key, lang) {
        var i18n = {
            ...
            da: {
                ...
                'Forecasts': 'Prognoser',
                'Forecasts - Own Ops': 'Prognoser - Egne Ops',
                'Forecasts - Adversary Ops': 'Prognoser - Modstander Ops',
                'Tidal predictions': 'Tidevandsprognoser',
                'Short range forecasts': 'Korte prognoser',
                'Short range forecasts - Own Ops': 'Korte prognoser - Egne Ops',
                'Short range forecasts - Adversary Ops': 'Korte prognoser - Modstander Ops',
                'Medium range forecasts': 'Mellemlange prognoser',
                'Medium range forecasts - Own Ops': 'Mellemlange prognoser - Egne Ops',
                'Medium range forecasts - Adversary Ops': 'Mellemlange prognoser - Modstander Ops',
                'Sea level': 'Vandstand',
